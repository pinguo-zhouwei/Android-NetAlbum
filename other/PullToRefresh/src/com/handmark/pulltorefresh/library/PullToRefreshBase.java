...
//                if (!mScrollingWhileRefreshingEnabled) {
                ...
                if (isReadyForPull()) {
                    Log.i(LOG_TAG, "ACTION_MOVE start");
                    ...
                    Log.i(LOG_TAG, "ACTION_MOVE 1");
                    if (absDiff > mTouchSlop && (!mFilterTouchEvents || absDiff > Math.abs(oppositeDiff))) {
                        Log.i(LOG_TAG, "ACTION_MOVE 2");
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (isReadyForPull()) {
                    Log.i(LOG_TAG, "ACTION_DOWN start");
...
//        if (!mScrollingWhileRefreshingEnabled) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_MOVE: {
                if (mIsBeingDragged) {
                    ...
                    Log.i(LOG_TAG, "onTouchEvent pullEvent");
                    pullEvent();
                    return true;
                }
                break;
    ...
    public final void triggerPullFromStart() {
        mCurrentMode = Mode.PULL_FROM_START;
        setRefreshing(true);
    }
    /**
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                ...
                default:
                    switch (mode) {
                        case PULL_FROM_END:
                            return new FooterLoadingLayout(context, mode, scrollDirection, attrs);
                        default:
                            return new HeaderLoadingLayout(context, mode, scrollDirection, attrs);
                    }
//                case FLIP:
